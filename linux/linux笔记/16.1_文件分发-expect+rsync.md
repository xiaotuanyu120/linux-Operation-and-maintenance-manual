...
# expect login.exp root 192.168.0.30    
...
rsync
===============================================
作用：一个快速、多功能、远程（含本地）的文件拷贝工具
man page description
a fast, versatile, remote (and local) file-copying tool
语法：rsync [参数] 源文件(可远程) 目标文件(可远程)
man page description
...
# rsync -av /root/shell root@192.168.0.30:/tmp
root@192.168.0.30's password:
...
## web01上再次运行
# expect rsync.expect root 192.168.0.30
...
# cat rsynclist
/root/good
# expect /root/shell/expect/autors.expect root 192.168.0.30 rsynclist
