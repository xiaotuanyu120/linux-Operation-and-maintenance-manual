---
title: 2.2.0: example 使用ansible环境变量获取主机JAVA_HOME
date: 2016-10-17 15:02:00
categories: devops/ansible
tags: [ansible,lookup,environment]
---
...
### 1. 解决问题的思路过程
#### 1) 思路1、使用command模块执行which java获取
``` bash
# inventory内容
*********************************
[test]
...
#### 2) 思路2、使用lookup获取PATH变量，然后在去执行which java
``` bash
# inventory内容
*********************************
[test]
