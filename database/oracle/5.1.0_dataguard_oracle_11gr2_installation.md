...
此例中，我们给node2和node3的db_unique_name分别为EXAMPLE_STBY1和EXAMPLE_STBY2
...
ALTER SYSTEM SET LOG_ARCHIVE_DEST_2='SERVICE=example_stby2 NOAFFIRM ASYNC VALID_FOR=(ONLINE_LOGFILES,PRIMARY_ROLE) DB_UNIQUE_NAME=EXAMPLE_STBY2';
...
``` sql
ALTER SYSTEM SET FAL_SERVER=EXAMPLE_STBY1;
--ALTER SYSTEM SET DB_FILE_NAME_CONVERT='EXAMPLE_STBY1','EXAMPLE' SCOPE=SPFILE;
--ALTER SYSTEM SET LOG_FILE_NAME_CONVERT='EXAMPLE_STBY1','EXAMPLE' SCOPE=SPFILE;
